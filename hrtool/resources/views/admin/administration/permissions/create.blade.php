                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('permissions.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right" style="margin-bottom: 4px;">Permission Name:</label>
                        ...
                        <div class="form-group row">
                            <label for="group_name" class="col-md-4 col-form-label text-md-right" style="margin-bottom: 4px;">Permission Group Name:</label>
                            <div class="col-md-6">
